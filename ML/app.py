    ...
    for email in emails:
        ...
        try:
            ...
            if predicted_category == "Finance":
                forward_email(email_id, "bhaveshdeore@hackohire.onmicrosoft.com", "Bhavesh Deore")
            elif predicted_category == "Travel":
                forward_email(email_id, "pratikdavare.onmicrosoft.com", "Pratik Davare")
            elif predicted_category == "Energy":
                forward_email(email_id, "sohamchavan@hackohire.onmicrosoft.com", "Soham Chavan")
            elif predicted_category == "Pharmaceuticals":
                forward_email(email_id, "pratikdavare@hackohire.onmicrosoft.com", "Pratik Davare")
            elif predicted_category == "Energy":
                forward_email(email_id, "bhaveshdeore@hackohire.onmicrosoft.com", "Bhavesh Deore")
